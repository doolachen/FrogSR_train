...
from fogsr.utils import scandir
from fogsr.utils.lmdb_util import make_lmdb_from_imgs
...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    folder_path = '/home/cbj/dataset/DIV2K/DIV2K_train_HR_sub'
    lmdb_path = '/home/cbj/dataset/DIV2K/DIV2K_train_HR_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    folder_path = 'dataset/DIV2K/DIV2K_train_LR_bicubic/X2_sub'
    lmdb_path = 'dataset/DIV2K/DIV2K_train_LR_bicubic_X2_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    folder_path = '/home/cbj/dataset/DIV2K/DIV2K_train_LR_bicubic/X3_sub'
    lmdb_path = '/home/cbj/dataset/DIV2K/DIV2K_train_LR_bicubic_X3_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    folder_path = '/home/cbj/dataset/DIV2K/DIV2K_train_LR_bicubic/X4_sub'
    lmdb_path = '/home/cbj/dataset/DIV2K/DIV2K_train_LR_bicubic_X4_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
def create_lmdb_for_reds():
    ...
    """
    # train_sharp
    folder_path = '/home/cbj/dataset/REDS/train/train_sharp'
    lmdb_path = '/home/cbj/dataset/REDS/train/train_sharp_with_val.lmdb'
    ...
    # train_sharp_bicubic
    folder_path = '/home/cbj/dataset/REDS/train/train_sharp_bicubic'
    lmdb_path = '/home/cbj/dataset/REDS/train/train_sharp_bicubic_with_val.lmdb'
    img_path_list, keys = prepare_keys_reds(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)
...
def create_lmdb_for_vimeo90k():
    ...
    """
    # GT
    folder_path = 'dataset/vimeo90k/vimeo_septuplet/sequences'
    lmdb_path = 'dataset/vimeo90k/vimeo90k_train_GT_only4th.lmdb'
    train_list_path = 'dataset/vimeo90k/vimeo_septuplet/sep_trainlist.txt'
    img_path_list, keys = prepare_keys_vimeo90k(folder_path, train_list_path, 'gt')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)

    # LQ
    folder_path = 'dataset/vimeo90k/vimeo_septuplet_matlabLRx4/sequences'
    lmdb_path = 'dataset/vimeo90k/vimeo90k_train_LR7frames.lmdb'
    train_list_path = 'dataset/vimeo90k/vimeo_septuplet/sep_trainlist.txt'
