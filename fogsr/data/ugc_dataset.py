...
class UGCDataset(data.Dataset):
    """UGC dataset for training.

    The keys are generated from a meta info txt file.
    basicsr/data/meta_info/meta_info_UGC_GT.txt
    ...
    Args:
        ...
        val_partition (str): Validation partition types. 'UGC4' or 'official'.
    ...
    def __init__(self, opt):
        ...
        if opt['val_partition'] == 'UGC4':
            ...
            raise ValueError(f'Wrong validation partition {opt["val_partition"]}.'
                             f"Supported ones are ['official', 'UGC4'].")
