...
class BasicModule(nn.Module):
    ...
    def fuse_modules(self):
        return torch.quantization.fuse_modules(self, [
            ['basic_module.0', 'basic_module.1'],
            ['basic_module.2', 'basic_module.3'],
            ['basic_module.4', 'basic_module.5'],
            ['basic_module.6', 'basic_module.7'],
        ])
...
class SpyNet(nn.Module):
    ...
    def __init__(self, load_path=None, return_levels=[5]):
        ...
        if load_path is None:
            load_path = 'spynet_sintel_final-3d2a1287.pth'
    ...
    def fuse_modules(self):
        self.basic_module = nn.ModuleList([b.fuse_modules() for b in self.basic_module])
